/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: fb511c79edb8d561fe77cfa774820b21)
...
declare namespace Cloudflare {
	interface Env {
		...
		MEMBERSHIP_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").MembershipDurableObject>;
		ASSETS: Fetcher;
