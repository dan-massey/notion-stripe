/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 42be36740e9819c6584f1643a9127057)
// Runtime types generated with workerd@1.20250712.0 2025-07-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BACKFILL_KV: KVNamespace;
		...
		STRIPE_SANDBOX_KEY: string;
		STRIPE_APP_SIGNING_SECRET: string;
		WEBHOOK_LIVE_SIGNING_SECRET: string;
		WEBHOOK_TEST_SIGNING_SECRET: string;
		WEBHOOK_SANDBOX_SIGNING_SECRET: string;
		ACCOUNT_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").AccountDurableObject>;
		STRIPE_ENTITY_COORDINATOR: DurableObjectNamespace<import("./src/index").StripeEntityCoordinator>;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_OAUTH_CLIENT_ID" | "NOTION_OAUTH_CLIENT_SECRET" | "BASE_URL" | "NOTION_AUTH_URL" | "STRIPE_LIVE_KEY" | "STRIPE_TEST_KEY" | "STRIPE_SANDBOX_KEY" | "STRIPE_APP_SIGNING_SECRET" | "WEBHOOK_LIVE_SIGNING_SECRET" | "WEBHOOK_TEST_SIGNING_SECRET" | "WEBHOOK_SANDBOX_SIGNING_SECRET">> {}
}
